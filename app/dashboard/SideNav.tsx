...
import { Search, Clock, Coin, Upload, Key, Building, Mail } from "../icons";
...
const LINKS = [
  ...
  { href: "/dashboard/email", label: "Email", icon: Mail, exact: false },
  { href: "/dashboard/crm", label: "CRM", icon: Building, exact: false },
